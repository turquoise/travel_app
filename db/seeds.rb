...
t6 = Tag.create(title: "Science", image: "http://images.techtimes.com/data/images/full/167280/world-science-day-is-an-international-event-which-began-in-2001.jpg?w=600")
Destination.create(name: "Science Museum", description: "From rockets to satellites, probes to landers, this gallery showcases some out-of-this world objects. Explore how we’ve sent spacecraft to other planets, walked on the Moon and peered into the heart of our galaxy and beyond.", image: "https://media.timeout.com/images/101633893/617/347/image.jpg", tag_id: t6.id)
Destination.create(name: "Hong Kong Science Museum", description: "The science-themed museum hand-on, with over 500 interactive exhibits ranging over a variety of topics such as robotics and virtual reality.", image: "http://ilovehongkong.org/wp-content/uploads/2012/10/Hong-Kong-Science-Museum-9.jpg", tag_id: t6.id)
Destination.create(name: "Experimentarium, Cophenhagen", description: "At Experimentarium City you can expect to learn about the wonderful world that surrounds you through play and exciting experiences. Can you ride a reverse steering bike, can you control your brainwaves, and can you guess the smell? ", image: "http://media-cdn.tripadvisor.com/media/photo-s/03/7e/42/48/experimentarium.jpg", tag_id: t6.id)
